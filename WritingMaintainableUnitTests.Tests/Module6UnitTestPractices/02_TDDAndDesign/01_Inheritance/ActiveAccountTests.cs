...
namespace WritingMaintainableUnitTests.Tests.Module6UnitTestPractices._02_TDDAndDesign._01_Inheritance
{
    [Specification]
    public class When_opening_a_new_account
    {
        ...
        {
            _result.AccountName.Should_be_equal_to("New account name");
        }
    ...
    public class When_changing_the_name_of_an_active_account
    {
        ...
        {
            _sut.AccountName.Should_be_equal_to("New active account name");
        }
